			...
			<div class="col-md-12">
				<div class="portlet box green-haze ">
					...
					<div class="portlet-body form form-horizontal">
						...
						<form class="form-horizontal" action="{{ url('updateorder') }}" method="post" role="form" id="customerForm">
							{{ csrf_field() }}
							<div class="form-body" id="customerSection">
								...
								<!-- <div class="form-group">
									<div class="col-md-6">
										...
										<div class="col-md-9 {{ $errors->has('cuscontactno') ? 'has-error' : '' }}">
											<select class="form-control" name="searchCustomer" id="searchCustomer">
												<option value="{{ $customerinfo->contactno }}">{{ $customerinfo->contactno }}</option>
											</select>
										</div>
									</div>
								</div> -->
								...
								<div class="form-group" >
									<div class="col-md-6">
										...
										<div class="col-md-9 {{ $errors->has('cuscontactno') ? 'has-error' : '' }}">
											<input class="form-control" value="{{ $customerinfo->contactno }}" name="cuscontactno" id="cuscontactno" readonly="">
									...
									<div class="col-md-6">
										...
										<div class="col-md-9 {{ $errors->has('cusname') ? 'has-error' : '' }}">
											<input type="text" name="cusname" value="{{ $customerinfo->name }}" id="cusname" class="form-control" placeholder="Customer Name" readonly="">
								...
								<div class="form-group" > 
									<div class="col-md-6">
										...
										<div class="col-md-9 {{ $errors->has('cusaddress') ? 'has-error' : '' }}">
											<textarea class="form-control" name="address" id="address" placeholder="Address" readonly=""><?php echo $orderData->shippingaddress; ?></textarea> 
								...
								<div class="form-group" >
									...
									<input type="hidden" name="myorderno" value="{{ $orderData->ordernumber }}">
									<input type="hidden" name="customerid" value="{{ $customerinfo->customerid }}">

									<input type="hidden" name="orderid" value="{{ $orderData->orderid }}">

									<input type="hidden" name="locationid" value="{{ $orderData->locationid }}">
									<input type="hidden" name="branchid" value="{{ $orderData->branchid }}">

									<input type="hidden" name="orderstatus" value="{{ $orderData->orderstatus }}">
									<input type="hidden" name="paymentmethod" value="{{ $orderData->paymentmethod }}">
                                    <input type="hidden" name="specialinstruction" value="{{ $orderData->specialinstruction }}">
									...
									<div class="col-md-6">
										...
										<div class="col-md-9 {{ $errors->has('specialinstruction') ? 'has-error' : '' }}">
											<textarea class="form-control" name="specialinstruction" placeholder="Write comments if you are alergic to something. eg: no mayo, no onion, etc." readonly=""><?php echo $orderData->specialinstruction; ?></textarea> 
										...
										<div class="col-md-4">
											...
											<div class="col-md-10 {{ $errors->has('location') ? 'has-error' : '' }}">
												<select class="form-control select2me" name="location" id="">
													...
													@endforeach -->
													<option value="{{ $orderData->locationid }}">{{ $orderData->zonename }}</option>
												</select>
										...
										<div class="col-md-4">
											...
											<div class="col-md-10 {{ $errors->has('branch') ? 'has-error' : '' }}">
												<select class="form-control select2" name="branch" id="branchid">
													...
													<option value="{{ $orderData->branchid }}">{{ $orderData->branchname }}</option>
												</select>
						...
						<div class="form-body cart-container">
							...
							<div class="cart-price-holder" id="cart-price-holder" >
								...
								<div class="row static-info">
									...
									<div class="col-md-7 value" id="cart-vat">
										0.00 Tk
									</div>
								</div>
							...
							<div class="row">
								<!-- <div class="col-md-offset-3 col-md-9" align="center"> -->
									<div class="col-md-12" align="center">
										<button type="submit" class="btn green" onclick="$('#customerForm').submit()">Update Order</button>
