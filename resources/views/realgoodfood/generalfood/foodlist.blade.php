...
<div class="page-content">
	...
	<!-- BEGIN PAGE HEADER-->
	<h3 class="page-title">
		Food List <small>create and edit</small>
	</h3>
	<div class="page-bar">
		...
		<div class="col-md-12">
			<div class="portlet box green-haze">
				<div class="portlet-title">
					<div class="caption">
						<i class="fa fa-home"></i>General Food List
					</div>
					</div>
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{{ route('general-food.create') }}" class="btn green">
							...
							<table class="table table-striped table-bordered table-hover" id="sample_1">
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<img src="{{ url('upload/menu/thumbnail_images/'.$food['originalpicture']) }}">
										</td>
										<td>
											@if($food['status'] == 1)
										...
										<td align="center">
											<a href="{{ route('general-food.edit',$food['id']) }}" class="btn btn-circle btn-xs purple id">
