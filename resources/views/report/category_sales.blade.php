									...
									<div class="row global">
										...
										<div class="col-md-4">
											<div class="form-group">
												...
												<div class="col-md-7">
													<select class="form-control select2me" style="width: 100%" name="categoryid" id="categoryid">
					...
					<div class="row">
						<div class="col-md-12">
							<h2 class="text-center" style="background-color: #c0c2c1 !important; padding: 10px;-webkit-print-color-adjust: exact;">
								...
								<small>Category : <span id="category">*****</span></small><br>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.searchBtn').on('click',function(){
			...
			var url = "{{ url('category-sales-report-ajax') }}";
				...
				success:function(data)
				{
					...
					if(data.length > 0){
						$.each(data,function(index,value){
							...
							htmlString += "<td>"+value.member.member_id+"</td>";
							...
							htmlString += "<td>"+value.waiter.fullname+"</td>";
							htmlString += "</tr>";
						});
