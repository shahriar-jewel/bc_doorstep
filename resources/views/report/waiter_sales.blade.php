...
@section('content')
	<div class="page-content">
		...
		<!-- BEGIN PAGE HEADER-->
		<h3 class="page-title">
		Waiter Sales Report <small>create and edit</small>
		</h3>
		<div class="page-bar">
				...
				<div class="portlet box green-haze ">
					...
					<div class="portlet box green">
						<div class="portlet-title">
							...
							<div class="tools">
								<a href="{{ url('waiter-sales-report-download') }}"><button type="button" class="btn white">excel Download</button></a>
							</div>
						</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		$('.searchBtn').on('click',function(){
			...
			var from = $('#from').val();
			var to = $('#to').val();
			var url = "{{ url('waiter-sales-report-ajax') }}";
			var htmlString = "";
			var orderfrom;
			var statuses;
			if(from == ''){
					...
					success:function(data)
					{
						...
						if(data.length > 0){
							$.each(data,function(index,value){
								htmlString += "<tr>";
								htmlString += "<td>"+value.fullname+"</td>";
