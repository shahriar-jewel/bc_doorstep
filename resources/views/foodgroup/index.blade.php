			...
			<div class="col-md-12">
				 <div class="portlet box green-haze">
					<div class="portlet-title">
						<div class="caption">
							<i class="icon-bag"></i>Food Group List
						</div>
						<!-- <div class="tools">
						</div> -->
						<div class="actions">
					...
					<div class="portlet-body">
						<div class="table-toolbar">
							<div class="row">
								<div class="col-md-6">
									<div class="btn-group">
										<a href="{{ route('foodgroup.create') }}" class="btn green">
										<i class="fa fa-plus"></i> Add New</a>
									</div>
								</div>
								<div class="col-md-6">
						...
						<div class="">
							...
							<table class="table table-striped table-bordered table-hover" id="foodgroupInfo">
							<thead>
							<tr>
								<th>
									#
...
<script>
	...
	$(document).ready(function(){
		$('#foodgroupInfo').DataTable({
	        "processing": true,
	        "serverSide": true,
	        "ajax":{
	                 "url": "{{ url('ajax/foodgroupinfo') }}",
	                 "dataType": "json",
	                 "type": "POST",
